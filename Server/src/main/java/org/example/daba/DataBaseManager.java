...
//        createEnumFormOfEducation();
    ...
    public void insertIntoStudyGroup(long groupId, String userName, String groupName, LocalDateTime creationDate, int studentsCount, long expelledStudents, int transferredStudents, FormOfEducation formOfEducation, long personId) throws SQLException {
        ...
        if (rs.next()) {
            ...
            try {
                ...
                preparedStatement.setLong(9, personId);
