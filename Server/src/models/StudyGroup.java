...
public class StudyGroup implements Serializable {
    ...
    public StudyGroup(long group_id, String groupName, LocalDateTime creationDate, Coordinates coordinates, int studentsCount, Long expelledStudents, Integer transferredStudents, FormOfEducation formOfEducation, String userName, Person groupAdmin){
