...
public class FillCollectionObjectDialogStage implements Initializable {
    ...
    private void setTableStage(TableStage tableStage){
        ...
        if (validateInput()) {
            ...
            pause.setOnFinished(insertEvent -> {
                ...
                try {
                    ...
                    System.err.println("Collection Commands Stage error " + e.getMessage());
                }
                ...
                if (Objects.equals(response, "1")){
                    ...
                    alert.setTitle(null);
                    alert.setHeaderText(null);
                    alert.setContentText("Something wrong with adding new new study group object!");
                    alert.show();
                }
            });
        }
