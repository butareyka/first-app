...
public class TableStage implements Initializable {
    public static Map<Long, Object> groupResponse = new LinkedHashMap<>();
    ...
    @FXML
    void removeGreaterKey(MouseEvent event) {
        // Implementation
    }

    @FXML
    void removeKey(MouseEvent event) {
        // Implementation
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        pause.setOnFinished(event -> {
            try {
                ...
                System.err.println("TableStage " + e.getMessage());
                Client.connecting();
            }
        });
        pause.play();
